...
export const CNAES_DB: CnaeInfo[] = [
  ...
  // ════════════════════════════════════════════════════════════
  C({ codigo: '4110-7/00', descricao: 'Incorporação de empreendimentos imobiliários', anexoSimples: 'IV', impedidoSimples: false, fatorRAplicavel: false, tipoAtividade: 'servico', riscoVigilancia: 'Baixo', riscoBombeiros: 'Baixo', conselhoClasse: 'CREA/CAU', licencasObrigatorias: L(['Registro no CRECI', 'Registro de Incorporação (Cartório)', 'Licença Prefeitura']), observacoes: '⚠️ Na prática, incorporadoras raramente se enquadram no Simples Nacional: o volume de negócios geralmente ultrapassa o limite de R$ 4,8M/ano, e o Regime Especial de Tributação (RET/patrimônio de afetação) é frequentemente mais vantajoso. Análise individual obrigatória.' }),
